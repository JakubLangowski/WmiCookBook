    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@gmail.com", new byte[] { 172, 56, 74, 32, 26, 56, 65, 72, 148, 205, 213, 42, 107, 70, 186, 163, 249, 180, 39, 192, 74, 143, 254, 61, 48, 211, 66, 28, 133, 247, 102, 125, 161, 7, 57, 119, 20, 102, 131, 22, 169, 107, 109, 49, 54, 98, 161, 20, 70, 23, 124, 58, 57, 37, 254, 116, 218, 9, 31, 128, 48, 182, 151, 35 }, new byte[] { 231, 49, 26, 66, 154, 30, 23, 237, 134, 188, 237, 82, 240, 7, 10, 214, 152, 225, 136, 34, 96, 44, 38, 247, 144, 9, 37, 99, 227, 77, 245, 166, 68, 86, 190, 212, 24, 4, 5, 185, 36, 213, 231, 67, 129, 50, 71, 39, 88, 15, 211, 107, 130, 135, 243, 23, 234, 188, 194, 106, 38, 145, 94, 206, 43, 89, 83, 206, 237, 57, 65, 152, 64, 61, 140, 83, 118, 176, 89, 116, 224, 242, 85, 160, 216, 25, 118, 104, 64, 140, 235, 182, 51, 210, 231, 49, 133, 9, 185, 235, 97, 38, 35, 92, 60, 244, 96, 95, 151, 33, 114, 109, 28, 73, 21, 25, 6, 233, 5, 162, 179, 57, 230, 143, 92, 162, 75, 65 } },
                    { 2, "user@gmail.com", new byte[] { 172, 56, 74, 32, 26, 56, 65, 72, 148, 205, 213, 42, 107, 70, 186, 163, 249, 180, 39, 192, 74, 143, 254, 61, 48, 211, 66, 28, 133, 247, 102, 125, 161, 7, 57, 119, 20, 102, 131, 22, 169, 107, 109, 49, 54, 98, 161, 20, 70, 23, 124, 58, 57, 37, 254, 116, 218, 9, 31, 128, 48, 182, 151, 35 }, new byte[] { 231, 49, 26, 66, 154, 30, 23, 237, 134, 188, 237, 82, 240, 7, 10, 214, 152, 225, 136, 34, 96, 44, 38, 247, 144, 9, 37, 99, 227, 77, 245, 166, 68, 86, 190, 212, 24, 4, 5, 185, 36, 213, 231, 67, 129, 50, 71, 39, 88, 15, 211, 107, 130, 135, 243, 23, 234, 188, 194, 106, 38, 145, 94, 206, 43, 89, 83, 206, 237, 57, 65, 152, 64, 61, 140, 83, 118, 176, 89, 116, 224, 242, 85, 160, 216, 25, 118, 104, 64, 140, 235, 182, 51, 210, 231, 49, 133, 9, 185, 235, 97, 38, 35, 92, 60, 244, 96, 95, 151, 33, 114, 109, 28, 73, 21, 25, 6, 233, 5, 162, 179, 57, 230, 143, 92, 162, 75, 65 } }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2021, 2, 9, 10, 23, 13, 914, DateTimeKind.Local).AddTicks(692), 2, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/lasagne-z-sosem-bolognese.jpg", true, true, "Lasagne", 60 },
                    { 2, 1, new DateTime(2021, 2, 9, 10, 23, 13, 916, DateTimeKind.Local).AddTicks(4862), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/makaron-z-kurczakiem-i-sosem-smietanowym.jpg", true, true, "Makaron z kurczakiem i sosem śmietanowym", 45 },
                    { 3, 1, new DateTime(2021, 2, 9, 10, 23, 13, 916, DateTimeKind.Local).AddTicks(4910), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/super-szybkie-tagliatelle-z-kurczakiem658590.jpg", true, true, "Super szybkie tagliatelle z kurczakiem", 25 },
                    { 4, 2, new DateTime(2021, 2, 9, 10, 23, 13, 916, DateTimeKind.Local).AddTicks(4928), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/frittata-z-dynia-i-serem-feta.jpg", true, true, "Pieczona dynia z fetą i oliwkami", 40 },
                    { 5, 3, new DateTime(2021, 2, 9, 10, 23, 13, 916, DateTimeKind.Local).AddTicks(4939), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/roladki-po-bolonsku543812.jpg", true, true, "Roladki po bolońsku", 45 },
                    { 6, 3, new DateTime(2021, 2, 9, 10, 23, 13, 916, DateTimeKind.Local).AddTicks(4951), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/curry-z-kurczaka.jpg", true, true, "Kurczak curry", 45 },
                    { 7, 4, new DateTime(2021, 2, 9, 10, 23, 13, 916, DateTimeKind.Local).AddTicks(4961), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/nalesniki-z-kurczakiem-i-pieczarkami-2.jpg", true, true, "Naleśniki z kurczakiem i pieczarkami", 45 }
                });

    ...
    public partial class Inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@gmail.com", new byte[] { 133, 123, 181, 78, 83, 245, 41, 83, 165, 242, 160, 16, 244, 114, 164, 183, 76, 165, 60, 40, 177, 47, 142, 181, 161, 58, 37, 242, 236, 137, 121, 74, 225, 228, 118, 105, 9, 104, 90, 62, 157, 66, 11, 14, 69, 220, 24, 82, 188, 221, 197, 80, 75, 48, 145, 199, 53, 154, 13, 245, 200, 95, 59, 191 }, new byte[] { 155, 241, 102, 236, 233, 103, 154, 22, 223, 20, 7, 241, 186, 93, 77, 41, 194, 152, 103, 160, 241, 25, 159, 34, 150, 91, 183, 175, 150, 238, 23, 151, 246, 103, 249, 181, 147, 32, 50, 122, 41, 131, 245, 216, 181, 0, 85, 163, 255, 85, 205, 206, 30, 91, 115, 160, 137, 215, 240, 24, 137, 79, 114, 245, 108, 100, 175, 20, 187, 206, 232, 244, 23, 241, 134, 179, 118, 215, 196, 44, 111, 113, 242, 89, 183, 102, 66, 144, 89, 249, 216, 255, 250, 190, 157, 211, 179, 197, 194, 236, 179, 216, 105, 163, 92, 183, 109, 32, 109, 138, 44, 162, 51, 174, 25, 0, 172, 239, 120, 71, 98, 210, 155, 103, 70, 15, 46, 86 } },
                    { 2, "user@gmail.com", new byte[] { 133, 123, 181, 78, 83, 245, 41, 83, 165, 242, 160, 16, 244, 114, 164, 183, 76, 165, 60, 40, 177, 47, 142, 181, 161, 58, 37, 242, 236, 137, 121, 74, 225, 228, 118, 105, 9, 104, 90, 62, 157, 66, 11, 14, 69, 220, 24, 82, 188, 221, 197, 80, 75, 48, 145, 199, 53, 154, 13, 245, 200, 95, 59, 191 }, new byte[] { 155, 241, 102, 236, 233, 103, 154, 22, 223, 20, 7, 241, 186, 93, 77, 41, 194, 152, 103, 160, 241, 25, 159, 34, 150, 91, 183, 175, 150, 238, 23, 151, 246, 103, 249, 181, 147, 32, 50, 122, 41, 131, 245, 216, 181, 0, 85, 163, 255, 85, 205, 206, 30, 91, 115, 160, 137, 215, 240, 24, 137, 79, 114, 245, 108, 100, 175, 20, 187, 206, 232, 244, 23, 241, 134, 179, 118, 215, 196, 44, 111, 113, 242, 89, 183, 102, 66, 144, 89, 249, 216, 255, 250, 190, 157, 211, 179, 197, 194, 236, 179, 216, 105, 163, 92, 183, 109, 32, 109, 138, 44, 162, 51, 174, 25, 0, 172, 239, 120, 71, 98, 210, 155, 103, 70, 15, 46, 86 } }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2021, 2, 9, 12, 7, 55, 492, DateTimeKind.Local).AddTicks(8450), 2, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/lasagne-z-sosem-bolognese.jpg", true, true, "Lasagne", 60 },
                    { 2, 1, new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7638), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/makaron-z-kurczakiem-i-sosem-smietanowym.jpg", true, true, "Makaron z kurczakiem i sosem śmietanowym", 45 },
                    { 3, 1, new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7690), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/super-szybkie-tagliatelle-z-kurczakiem658590.jpg", true, true, "Super szybkie tagliatelle z kurczakiem", 25 },
                    { 4, 2, new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7754), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/frittata-z-dynia-i-serem-feta.jpg", true, true, "Pieczona dynia z fetą i oliwkami", 40 },
                    { 5, 3, new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7768), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/roladki-po-bolonsku543812.jpg", true, true, "Roladki po bolońsku", 45 },
                    { 6, 3, new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7779), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/curry-z-kurczaka.jpg", true, true, "Kurczak curry", 45 },
                    { 7, 4, new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7791), 1, "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/nalesniki-z-kurczakiem-i-pieczarkami-2.jpg", true, true, "Naleśniki z kurczakiem i pieczarkami", 45 }
                });

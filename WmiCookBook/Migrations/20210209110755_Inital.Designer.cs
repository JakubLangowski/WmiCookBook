...
namespace WmiCookBook.Migrations
{
    ...
    [Migration("20210209110755_Inital")]
            ...
            modelBuilder.Entity("WmiCookBook.Models.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2021, 2, 9, 12, 7, 55, 492, DateTimeKind.Local).AddTicks(8450),
                            Difficulty = 2,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7638),
                            Difficulty = 1,
                            Image = "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/makaron-z-kurczakiem-i-sosem-smietanowym.jpg",
                            IsAccepted = true,
                            IsFeatured = true,
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7690),
                            Difficulty = 1,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7754),
                            Difficulty = 1,
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7768),
                            Difficulty = 1,
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7779),
                            Difficulty = 1,
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 4,
                            CreatedAt = new DateTime(2021, 2, 9, 12, 7, 55, 495, DateTimeKind.Local).AddTicks(7791),
                            Difficulty = 1,
                            Image = "https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/nalesniki-z-kurczakiem-i-pieczarkami-2.jpg",
                            IsAccepted = true,
                            IsFeatured = true,
